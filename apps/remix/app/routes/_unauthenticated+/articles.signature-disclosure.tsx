  ...
  return (
    <div>
      <article className="prose dark:prose-invert">
        ...
        <p>
          <Trans>
            Thank you for using hSign to perform your electronic document signing. The purpose
        ...
        <p>
          <Trans>
            By proceeding to use the electronic signature service provided by hCloud, you affirm
